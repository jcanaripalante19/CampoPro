...
import {
  ...
  markReservationLocalPaid,
  updateReservationStatus,
} from '../../services/ownerService';

export default function EmployeeReservationsScreen() {
  ...
  const loadReservations = async () => {
    ...
    try {
      ...
      console.log('Error reservas empleado:', error);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleMarkPaid = async (reservationId) => {
    await markReservationLocalPaid(reservationId);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Reservas operativas</Text>
      <Text style={styles.subtitle}>
        Gestiona reservas y pagos en local.
      </Text>
